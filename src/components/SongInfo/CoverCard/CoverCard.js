								...
								{props.account && props.account === props.song.currentOwnerAddress ? (
									<span>
										...
										<p className="mt-1 cover_card_current_price">
											Current Price: {parseFloat(props.amount).toFixed(3)} EVMOS{" "}
									...
									>
										<span>
											BUY for {`${parseFloat(props.amount).toFixed(3)} `} EVMOS<i className="fas fa-angle-double-right"></i>
										</span>
									</button>
								) : props.account ? (
													...
													<div className="col sale_history_subsection p-0 transfer_money d-flex flex-cloumn flex-wrap justify-content-center">
														<div className="col-12 p-0 m-0 pt-2 mt-1 d-flex justify-content-center">
															...
															<span className="transaction_money mx-3 fw-bold pt-1">
																...
																<span className="transaction_money_unit">&nbsp;&nbsp;EVMOS</span>
															</span>
															{icon_arrowRight}
														</div>
							...
							<div className="modal-body">
								...
								<div className="row mt-5">
									<span className="m-0 p-0">
										Enter the new Price in EVMOS &nbsp;&nbsp;
										<Tooltip labelText="Know more" message={`1 EVMOS = $${props.evmosUSD} or ₹${props.evmosINR}`} />
									</span>
								</div>
								<div className="row mt-3">
									<input type="number" id="newPrice" className="input-text-field" placeholder="Enter Price in EVMOS" step="0.1" min="0" required />
								</div>
							</div>
