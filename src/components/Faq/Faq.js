...
export default function Faq() {
	var generalQuestions = [
		...
		},
		{
			...
			question: "Why build a dApp on Evmos?",
			answer: "This is a somewhat loaded question, but in simple terms Evmos connects users with decentralized applications (dapps) on Ethereum and Cosmos, allowing them to harness the liquidity of both networks. Also, the Evmos platform makes it easy for developers to create cross-chain dapps using Ethereum tooling and deploy them on Cosmos.",
		},
		{
			ID: "heading4",
	...
	var needQuestions = [
		...
		},
		{
			...
			question: "EVMOS, a digital currency",
			answer: `<span class="green_subhead">What is EVMOS? Why do I need it?</span>
					<br/>
					<ul>
						<li>EVMOS is a digital currency that powers the Evmos network, which is what Musicosmos is built on. EVMOS acts like any other currency— its value fluctuates with the market.</li>
						<li>You need to convert your currency (e.g. USD, INR, CAD, GBP) into EVMOS to trade NFTs on Musicosmos.</li>
					</ul>
			`,
		},
	];
	...
	var buyingAndSellingQuestions = [
		...
		},
		{
			...
			question: "I sold a song NFT. Where’s my EVMOS?",
			answer: `If you successfully sold an NFT through our marketplace, the other user definitely sent EVMOS. Since the user paid for the sale through our smart contract, the payment isn’t reflected as a typical IN/OUT transaction in Mintscan. (Mintscan is a read-only interface for the Evmos network that shows all events on the blockchain.)`,
		},
		{
			ID: "heading22",
		...
		},
		{
			...
			question: "Where does my EVMOS go when I buy an NFT?",
	...
	var transactionsAndTechnicalQuestions = [
		{
			...
			question: "What’s Mintscan?",
			answer: `Mintscan is a read-only interface for the Evmos network. It tells you everything that’s happened on the blockchain. It helps you verify that transactions were successful, and tracks other helpful details about transactions and addresses.`,
		},
		{
			ID: "heading28",
